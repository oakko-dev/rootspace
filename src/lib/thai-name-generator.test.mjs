...
const sampleData = {
	...
	firstnameFemale: [{ th: "มะลิ", en: "Mali" }],
	firstnameMale: [{ th: "นนท์", en: "Non" }],
	nicknameFemale: [{ th: "มิ้น", en: "Mint" }],
	nicknameMale: [{ th: "นัท", en: "Nat" }],
};
